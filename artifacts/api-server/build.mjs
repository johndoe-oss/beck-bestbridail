...
async function buildAll() {
  ...
  await esbuild({
    ...
    outExtension: { ".js": ".mjs" },
    logLevel: "info",
    // These used to be separate pnpm workspace packages (@workspace/*) that were
    // symlinked into node_modules. Now that everything lives under one
    // package.json, resolve them straight to their source files instead.
    alias: {
